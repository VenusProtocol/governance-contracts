...
const grantPermissions: Permissions = {
  ...
  unichainsepolia: [
    ...getResilientOraclePermissions(UNICHAINSEPOLIA_RESILIENT_ORACLE),
    ...getRedstoneOraclePermissions(UNICHAINSEPOLIA_REDSTONE_ORACLE),
    ...getBoundValidatorPermissions(UNICHAINSEPOLIA_BOUND_VALIDATOR),
    ...getXVSPermissions(UNICHAINSEPOLIA_XVS),
    ...getXVSBridgeAdminPermissions(UNICHAINSEPOLIA_XVS_BRIDGE_ADMIN),
    ...getXVSVaultPermissions(UNICHAINSEPOLIA_XVS_VAULT_PROXY),
    ...getPoolRegistryPermissions(UNICHAINSEPOLIA_POOL_REGISTRY),
    ...getPrimePermissions(UNICHAINSEPOLIA_PRIME),
    ...getPrimeLiquidityProviderPermissions(UNICHAINSEPOLIA_PLP),
    ...getProtocolShareReservePermissions(UNICHAINSEPOLIA_PSR),
    ...getComptrollerPermissions(),
    ...getVTokenPermissions(),
    ...getRewardDistributorPermissionsTimebased(),
    ...getIRMPermissions(),
  ...
  unichainmainnet: [
    ...getResilientOraclePermissions(UNICHAINMAINNET_RESILIENT_ORACLE),
    ...getRedstoneOraclePermissions(UNICHAINMAINNET_REDSTONE_ORACLE),
    ...getBoundValidatorPermissions(UNICHAINMAINNET_BOUND_VALIDATOR),
    ...getXVSPermissions(UNICHAINMAINNET_XVS),
    ...getXVSBridgeAdminPermissions(UNICHAINMAINNET_XVS_BRIDGE_ADMIN),
    ...getXVSVaultPermissions(UNICHAINMAINNET_XVS_VAULT_PROXY),
    ...getPoolRegistryPermissions(UNICHAINMAINNET_POOL_REGISTRY),
    ...getPrimePermissions(UNICHAINMAINNET_PRIME),
    ...getPrimeLiquidityProviderPermissions(UNICHAINMAINNET_PLP),
    ...getProtocolShareReservePermissions(UNICHAINMAINNET_PSR),
    ...getComptrollerPermissions(),
    ...getVTokenPermissions(),
    ...getRewardDistributorPermissionsTimebased(),
    ...getIRMPermissions(),
...
const revokePermissions: Permissions = {
  ...
  unichainsepolia: [
    ...getPrimeRevokePermissions(UNICHAINSEPOLIA_PRIME, UNICHAINSEPOLIA_GUARDIAN),
    ...getPrimeLiquidityProviderRevokePermissions(UNICHAINSEPOLIA_PLP, UNICHAINSEPOLIA_GUARDIAN),
    ...getResilientOracleRevokePermissions(UNICHAINSEPOLIA_RESILIENT_ORACLE, UNICHAINSEPOLIA_GUARDIAN),
    ...getBoundValidatorRevokePermissions(UNICHAINSEPOLIA_BOUND_VALIDATOR, UNICHAINSEPOLIA_GUARDIAN),
    ...getXVSVaultRevokePermissions(UNICHAINSEPOLIA_XVS_VAULT_PROXY, UNICHAINSEPOLIA_GUARDIAN),
    ...getRewardDistributorRevokePermissions(UNICHAINSEPOLIA_GUARDIAN, true),
    ...getIRMRevokePermissions(UNICHAINSEPOLIA_GUARDIAN),
    ...getPoolRegistryRevokePermissions(UNICHAINSEPOLIA_POOL_REGISTRY, UNICHAINSEPOLIA_GUARDIAN),
    ...getComptrollerRevokePermissions(UNICHAINSEPOLIA_GUARDIAN),
    ...getVTokenRevokePermissions(UNICHAINSEPOLIA_GUARDIAN),
    ...getXVSBridgeAdminRevokePermissions(UNICHAINSEPOLIA_XVS_BRIDGE_ADMIN, UNICHAINSEPOLIA_GUARDIAN),
  ],
  unichainmainnet: [
    ...getPrimeRevokePermissions(UNICHAINMAINNET_PRIME, UNICHAINMAINNET_GUARDIAN),
    ...getPrimeLiquidityProviderRevokePermissions(UNICHAINMAINNET_PLP, UNICHAINMAINNET_GUARDIAN),
    ...getResilientOracleRevokePermissions(UNICHAINMAINNET_RESILIENT_ORACLE, UNICHAINMAINNET_GUARDIAN),
    ...getBoundValidatorRevokePermissions(UNICHAINMAINNET_BOUND_VALIDATOR, UNICHAINMAINNET_GUARDIAN),
    ...getXVSVaultRevokePermissions(UNICHAINMAINNET_XVS_VAULT_PROXY, UNICHAINMAINNET_GUARDIAN),
    ...getRewardDistributorRevokePermissions(UNICHAINMAINNET_GUARDIAN, true),
    ...getIRMRevokePermissions(UNICHAINMAINNET_GUARDIAN),
    ...getPoolRegistryRevokePermissions(UNICHAINMAINNET_POOL_REGISTRY, UNICHAINMAINNET_GUARDIAN),
    ...getComptrollerRevokePermissions(UNICHAINMAINNET_GUARDIAN),
    ...getVTokenRevokePermissions(UNICHAINMAINNET_GUARDIAN),
    ...getXVSBridgeAdminRevokePermissions(UNICHAINMAINNET_XVS_BRIDGE_ADMIN, UNICHAINMAINNET_GUARDIAN),
  ],
};
