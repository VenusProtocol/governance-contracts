...
Snapshot block: 109200201 · Updated: 2026-07-10 · Contracts: 72 · Permissions: 351 · Verification: ✅ verified on-chain (as of 2026-07-12)
...
| `approvePositionTransfer(address,address)` | CriticalTimelock, FastTrackTimelock, Guardian 1, NormalTimelock |
| `cancelVault(address)` | CriticalTimelock, FastTrackTimelock, Guardian 1, NormalTimelock |
| `closeVault(address)` | CriticalTimelock, FastTrackTimelock, Guardian 1, NormalTimelock |
| `completePauseVault(address)` | CriticalTimelock, FastTrackTimelock, Guardian 1, NormalTimelock |
| `createVault(VaultConfig,InstitutionalConfig,RiskConfig,string,string,string)` | CriticalTimelock, FastTrackTimelock, Guardian 1, NormalTimelock |
| `openVault(address)` | CriticalTimelock, FastTrackTimelock, Guardian 1, NormalTimelock |
| `partialPauseVault(address)` | CriticalTimelock, FastTrackTimelock, Guardian 1, NormalTimelock |
| `revokePositionTransfer(address)` | CriticalTimelock, FastTrackTimelock, Guardian 1, NormalTimelock |
| `setComptroller(address)` | Guardian 1, NormalTimelock |
| `setInstitutionName(address,string)` | CriticalTimelock, FastTrackTimelock, Guardian 1, NormalTimelock |
| `setInstitutionNameOverride(address,string)` | CriticalTimelock, FastTrackTimelock, Guardian 1, NormalTimelock |
| `setLatePenaltyRate(address,uint256)` | CriticalTimelock, FastTrackTimelock, NormalTimelock |
| `setLiquidationAdapter(address)` | Guardian 1, NormalTimelock |
| `setLiquidationIncentive(address,uint256)` | CriticalTimelock, FastTrackTimelock, NormalTimelock |
| `setLiquidationThreshold(address,uint256)` | CriticalTimelock, FastTrackTimelock, NormalTimelock |
...
| Function | Grantees |
| --- | --- |
| `setCloseFactor(uint256)` | CriticalTimelock, FastTrackTimelock |
| `setLiquidatorWhitelist(address,bool)` | CriticalTimelock, FastTrackTimelock, Guardian 1, NormalTimelock |
| `setProtocolLiquidationShare(uint256)` | CriticalTimelock, FastTrackTimelock, NormalTimelock |
| `setSettlerWhitelist(address,bool)` | CriticalTimelock, FastTrackTimelock, Guardian 1, NormalTimelock |
| `sweepProtocolShareToReserve(address)` | CriticalTimelock, FastTrackTimelock, Guardian 1, NormalTimelock |
...
| `_setInterestRateModel(address)` | 0x8504EF43463c1edC9897182c6e17C0ad47B9Ad31, 0xB3eE9073a1a394ef242d27267C1A5D3b9ed739fA, 0xCD6956823F1Aaa5be19a6827aFC6d32AD1ef8800, CriticalTimelock, FastTrackTimelock, IRMRiskSteward / IRMRiskSteward_Proxy, NormalTimelock |
...
| `setActionsPaused(address[],uint256[],bool)` | CriticalTimelock, FastTrackTimelock, Guardian 2, NormalTimelock |
| `setCloseFactor(uint256)` | NormalTimelock, PoolRegistry / PoolRegistry_Proxy |
| `setCollateralFactor(address,uint256,uint256)` | CriticalTimelock, FastTrackTimelock, Guardian 1, NormalTimelock, PoolRegistry / PoolRegistry_Proxy |
| `setFlashLoanEnabled(bool)` | CriticalTimelock, FastTrackTimelock, Guardian 2, NormalTimelock |
| `setFlashLoanFeeMantissa(uint256,uint256)` | CriticalTimelock, FastTrackTimelock, Guardian 2, NormalTimelock |
| `setGrowthRate(uint256,uint256)` | CriticalTimelock, FastTrackTimelock, NormalTimelock |
| `setInterestRateModel(address)` | 0x0b086B866A5A91D5882ed355a34d268c62f8BE66, CriticalTimelock, FastTrackTimelock, NormalTimelock, SetCheckpointBscmainnet |
