...
/**
 * @title MultiTokenGovernanceStorage
 * @author Venus
 * @dev Storage Contract for MultiTokenGovernance
 */
contract MultiTokenGovernanceStorage {
    enum ProposalType {
        NORMAL,
        FASTTRACK,
        CRITICAL
...
/**
 * @title MultiTokenGovernorEvents
 * @author Venus
 * @notice Set of events emitted by the MultiTokenGovernor contracts.
 */
contract MultiTokenGovernanceInterface is MultiTokenGovernanceStorage {
    /** Events */
